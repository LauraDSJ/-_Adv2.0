            ...
            <div id="bs-container" class="">
              ...
              <div class="bsquare bsquare1 revealOnScroll"  data-animation="flipInX" id="bsquare4">
                <div class="centrise-t">
                  ...
                  <p class="hiden-f">With the explosion of APPs, PaaS, IaaS and the IoT markets, our founders were compelled to build production hubs on both sides of the world to help you meet the crushing demand.</p>
                </div>
              </div>
            </div>
             <div class="separation-50"></div>
