...
>>>>>>> origin/master
  ...
  <body data-shoptagr-mini="yes" data-pinterest-extension-installed="cr1.39.1">
    ...
    <!-- --------------------------------- -->
    <!-- --------------------------------- --> 
    <div class="container-fluid capabilities-top-bg">
      <div class="row">
        <div class="col-lg-12 full-height center-element" style="height: 352px;">
    ...
    <div class="container-fluid white-texture-bg"> 
      ...
      <div class="row">    
        <div class="col-lg-12 text-center">
          <h3>Our capability starts<br>
              with our accessibility.</h3>
        </div><!--col-md-3-->
      </div><!--row-->
      ...
      <div class="row">    
        <div class="col-sm-6 col-sm-offset-3 text-center">
          <h6>It is our practice to assign project managers that operate in your time zone and who are only an email, phone call, or instant message away and able to respond quickly if not instantly.</h6>
        </div><!--col-md-3-->
      </div><!--row--> 
    ...
    <div class="container-fluid capabilities-our-services-bg" data-parallax="scroll" data-image-src="img/capabilities-our-services-bg.jpg">
      ...
      <div class="row">    
        <div class="col-lg-12 text-center">
          <h5 class="text-uppercase text-white">Our Services</h5>
        </div>
      </div><!--row-->
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          <p class="text-white">We like to think of ourselves as technology facilitators with a range of services whose sole purpose is to keep your organization in front of change.</p>  
        </div>  
      </div><!--row--> 
      ...
      <div class="row">
        <div class="col-md-4 text-center se-qa">
          ...
          <div class="service-icon center-block">
            ...
            <img src="img/capabilities-qa-icon.png" alt="QA Icon">
          </div>    
        ...
        <div class="col-md-4 text-center se-dev">
          ...
          <div class="service-icon center-block">
            <div class="separation-10"></div>  
            <div class="separation-5"></div>    
            <img src="img/capabilities-developer-icon.png" alt="QA Icon">
          </div>  
        ...
        <div class="col-md-4 text-center se-des">
          ...
          <div class="service-icon center-block">
            <div class="separation-10"></div>  
            <div class="separation-5"></div> 
            <img src="img/capabilities-designer-icon.png" alt="QA Icon">
          </div> 
    ...
    <div class="container-fluid capabilities-survey-numbers-bg" data-parallax="scroll" data-image-src="img/capabilities-survey-numbers-bg.jpg">
      ...
      <div class="row">
        <div class="col-sm-4 text-center">
          ...
          <div class="percentage center-block">
            <div class="separation-10"></div> 
            <div class="separation-5"></div> 
            <h5 class="text-white">53%</h5>
          </div>
            
          <div class="separation-20"></div>    
            
          <p class="text-white">Of companies reported that they have outsourcing challenges because their companies lacks project management skills.</p>    
        </div><!--col-sm-4-->
        ...
        <div class="col-sm-4 text-center">
          ...
          <p class="text-white">Of companies reported that they lacked a good process for specifying work.</p>    
        </div><!--col-sm-4-->
        ...
        <div class="col-sm-4 text-center">
          ...
          <div class="percentage center-block">
            <div class="separation-10"></div> 
            <div class="separation-5"></div> 
            <h5 class="text-white">48%</h5>
          </div>
            
          <div class="separation-20"></div>    
            
          <p class="text-white">Of companies said that they did not have the right metrics for measuring performance.</p>    
        </div><!--col-sm-4-->  
      </div><!--row-->    
...
<div class="separation-100"></div> 
      ...
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2 text-center">
          <h6 class="text-white">Our Chief Happifying Officer, Josie Lopez, is passionate about building a vibrant company culture. Everyone at Advancio embodies our core values and they are spelled out the minute a new hire walks in the door.</h6> 
            
          <div class="separation-50"></div>
            
          <a href="#a" class="rectangle-btn">Join Our Team</a>    
            ...
            <div class="leader-tag">
              ...
              <div class="row">  
                <div class="col-xs-3 text-center">
                  <a href="#a"><img src="img/facebook-white.png" height="25" width="25"></a>
                </div>
                <div class="col-xs-3 text-center">    
                  <a href="#a"><img src="img/linkedin-white.png" height="25" width="25"></a>
                </div>
                <div class="col-xs-3 text-center">  
                  <a href="#a"><img src="img/google-plus-white.png" height="25" width="25"></a>
                </div>      
                <div class="col-xs-3 text-center">        
    ...
    <div class="container-fluid capabilities-top-talent-bg" data-parallax="scroll" data-image-src="img/capabilities-top-talent-bg.jpg">
      ...
      <div class="row">    
        <div class="col-sm-8 col-sm-offset-2 text-center">
          <h5 class="text-uppercase text-white">Let us introduce some of our Top Talent</h5>
        </div>  
      </div><!--row--> 
      ...
      <div class="row no-padding">
        ...
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square selectedProfile" id="Adrian"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Alfredo"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Anakaren"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Carlos"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Erick"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Hector"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Jorge"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Laura"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Mario"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Misael"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Orlando"></a>
        </div><!--col-xs-2-->
          
        <div class="col-sm-1 col-xs-2 no-padding">
          <a href="#a" class="team-member full-width square" id="Pepe"></a>
        </div><!--col-xs-2-->
        
      </div><!--row of pictures 1-->
        
      <div class="separation-100"></div>    
        
      <!--Profile Showcase-->
      <div class="row">
        <div class="col-xs-1 text-center"><h4 id="prev-slide-talent"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></h4></div>  
          
        <div class="col-xs-10">
            
          <div class="separation50"></div>    
          
          <div id="talentCarousel" class="carousel slide">
            <!-- Carousel items -->
            <div class="carousel-inner">
              ...
              <div class="active item" data-slide-number="0">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Adrian.jpg" class="img-circle full-width" alt="Adrian photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Adrian</h2>

                      <h5 class="text-white">Bachelor of: Science in Computer Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span>Oracle, PL/SQL, PHP, AJAX, FLEX, Salesforce, .NET, HTML, CSS, JS. </p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2010.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>
              ...
              <div class="item" data-slide-number="1">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Alfredo2.jpg" class="img-circle full-width" alt="Alfredo photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Alfredo</h2>

                      <h5 class="text-white">Bachelor of: Science in Computer Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span>C#, VB, VBA, SQL, PL-SQL, PHP, JQuery, Java.</p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2013.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>
              ...
              <div class="item" data-slide-number="2">
                <div class="row">    
                    ...
                    <div class="col-sm-4">
                      <img src="img/profiles/color/AnaKaren2.jpg" class="img-circle full-width" alt="Anakaren photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Anakaren</h2>

                      <h5 class="text-white">Bachelor of: Communications Degree</h5>

                      <p class="text-white"><span class="bold">Skills: </span> Public Relations, Events Organization, Community Manager, Recruitment, Human Resources</p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2012.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>
              ...
              <div class="item" data-slide-number="3">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Carlos2.jpg" class="img-circle full-width" alt="Carlos photo">
                    </div><!--col-xs-2-->
                    ...
                    <div class="col-sm-8" >
                      ...
                      <p class="text-white"><span class="bold">Skills: </span> Node.JS, C++, C#, .NET, PHP, JavaScript, HTML, CSS</p>  
              ...
              <div class="item" data-slide-number="4">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Erick2.jpg" class="img-circle full-width" alt="Erick photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Erick</h2>

                      <h5 class="text-white">Bachelor of: Software Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span> .NET, Java, HTML, CSS, Oracle DB, SQL, NodeJS, XAMPP</p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2014.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>
              ...
              <div class="item" data-slide-number="5">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Hector.jpg" class="img-circle full-width" alt="Hector photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Hector</h2>

                      <h5 class="text-white">Bachelor of: Software Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span> JavaScript, jQuery, Ajax, HTML, CSS3, ASP.NET, SQL Server, MySql</p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2011.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>    
              ...
              <div class="item" data-slide-number="6">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Jorge.jpg" class="img-circle full-width" alt="Jorge photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Jorge</h2>

                      <h5 class="text-white">Bachelor of: Science in Software Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span> C#, .NET, Visual Studio, ASP.NET, HTML5, jQuery, JSON, CSS</p>  
              ...
              <div class="item" data-slide-number="7">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Laura.jpg" class="img-circle full-width" alt="Laura photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Laura</h2>

                      <h5 class="text-white">Bachelor of: Digital Graphic Design Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span> UX/UI, HTML5, CSS3, jQuery, Bootstrap, Photoshop, Illustrator, Wordpress</p>  
              ...
              <div class="item" data-slide-number="8">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Mario.jpg" class="img-circle full-width" alt="Mario photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Mario</h2>

                      <h5 class="text-white">Bachelor of: Digital Graphic Design Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span> Photoshop, Illustrator, Dreamweaver, Flash, After Effects, HTML, CSS, Final Cut Pro X</p>  
              ...
              <div class="item" data-slide-number="9">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Misael.jpg" class="img-circle full-width" alt="Misael photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Misael</h2>

                      <h5 class="text-white">Bachelor of: Software Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span>C#, PHP, HTML5, JS, CSS, jQuery, Ajax, ASP.NET</p>  
              ...
              <div class="item" data-slide-number="10">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Orlando2.jpg" class="img-circle full-width" alt="Orlando photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Orlando</h2>

                      <h5 class="text-white">Bachelor of: Science in Software Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span>C#, JavaScript, CSS, HTML5, SQL, Oracle DB, ASP.NET, MVC and Webforms</p>  
              ...
              <div class="item" data-slide-number="11">
                <div class="row">    
                    ...
                    <div class="col-sm-4" >
                      <img src="img/profiles/color/Pepe2.jpg" class="img-circle full-width" alt="Pepe photo">
                    </div><!--col-xs-2-->

                    <div class="col-sm-8" >
                      <h2 class="text-white">Jose</h2>

                      <h5 class="text-white">Bachelor of: Science in Computer Engineering</h5>

                      <p class="text-white"><span class="bold">Skills: </span>HTML, JavaScript, XML, .NET, SQL, Siebel, Selenium, Webdriver</p>  

                      <p class="text-white"><span class="bold">Work Experience: </span>Since 2009.</p>  
                    </div><!--col-xs-2-->
                  </div><!--row-->
              </div>            
        ...
        <div class="col-xs-1 text-center"><h4 id="next-slide-talent"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></h4></div>    
      </div><!--row profiles carousel-->    
